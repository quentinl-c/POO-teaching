...
public class Concession {
	...
	public Voiture vendre(int numeroVoiture, double prix, int rejetCarbone) throws NonConformeException{
		if(numeroVoiture < this.parcAuto.size()) {
			this.soldeCompte += prix;
			if(this.parcAuto.get(numeroVoiture).estConforme(rejetCarbone)) {
